...
void main() {
  ...
  group(
    ...
    () {
      blocTest<AuthenticationCubit, AuthenticationState>(
        'It should emit [CreatingUser, UserCreated] when successful',
        build: () {
      ...
      blocTest<AuthenticationCubit, AuthenticationState>(
        'It Should emit [CreatingUser, AuthenticationError] when unsuccessful',
        build: () {
  ...
  group(
    ...
    () {
      blocTest<AuthenticationCubit, AuthenticationState>(
        'It should emit [GettingUsers, UsersLoaded] when successful',
        build: () {
      ...
      blocTest<AuthenticationCubit, AuthenticationState>(
        'It should emit [GettingUsers, AuthenticationError] when unsuccessful',
        build: () {
